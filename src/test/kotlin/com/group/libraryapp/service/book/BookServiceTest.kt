...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("임선영", null))
        val request = BookLoanRequest("임선영", "이상한 나라의 앨리스")
    ...
    @Test
    @DisplayName("책 대출 한 경우 신규 대출 실패")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("임선영", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 앨리스"))
        val request = BookReturnRequest("임선영", "이상한 나라의 앨리스")
